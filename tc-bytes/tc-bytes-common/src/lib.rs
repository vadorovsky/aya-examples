...
mod test {
    ...
    //     assert_eq!(find_x_forwarded_for_header(buf, buf.len()), (true, 17));
    //     let buf = b"foo bar X-Forwarded-For: 10.0.0.1";
    //     assert_eq!(find_x_forwarded_for_header(buf, buf.len()), (true, 25));
    //     let buf = b"";
    //     assert_eq!(find_x_forwarded_for_header(buf, buf.len()), (false, 0));
